...
object FormingMagicSquareV2Result {
  ...
  def formingMagicSquare(s: Array[Array[Int]]): Int = {
    ...
    def go(allPossiblesMagicSquares: Array[Array[Array[Int]]], minCost: Int = Int.MaxValue): Int = {
      if(allPossiblesMagicSquares.isEmpty) minCost
        ...
        getCost(allPossiblesMagicSquares.head.flatMap(_.toArray), s.flatMap(_.toArray))))
    }
...
object FormingMagicSquareV2Solution {
  def main(args: Array[String]) {
    ...
    val result = FormingMagicSquareV2Result.formingMagicSquare(s)
